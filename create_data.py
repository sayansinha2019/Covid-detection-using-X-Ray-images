...
train_cats_dir = os.path.join(train_dir,'COVID')
...
validation_cats_dir = os.path.join(validation_dir,'COVID')
...
test_cats_dir = os.path.join(test_dir, 'COVID')     
if not os.path.exists(test_cats_dir):
    os.mkdir(test_cats_dir)

test_dogs_dir = os.path.join(test_dir, 'NORMAL')
